        ...
        public:
            ...
            virtual void Deinitialize(PluginHost::IShell* service)
            {
                ...
                for (const auto& kv : m_versionHandlers) 
                {
                    ...
                    // Issue: Using auto causes unnecessary copy of std::string in iteration
                    // Fix: Use const reference to avoid copy overhead
                    for ( const auto& api : m_versionAPIs[kv.first] )
                    {
