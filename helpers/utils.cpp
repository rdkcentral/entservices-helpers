...
std::string Helpers::formatIARMResult(IARM_Result_t result)
{
    switch (result) {
...
bool Helpers::String::readPropertyValue(const std::string &str, std::vector<std::string> &stringList)
{
...
bool Helpers::readPropertyFromFile(const char* pfilename, const std::string& property, std::vector<std::string> &stringList)
{
